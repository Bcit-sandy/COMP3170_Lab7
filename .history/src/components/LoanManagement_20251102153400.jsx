...
function LoanManagement({ books, loans, onLoanChange, onQuit }) {
  ...
  const handleLoanBook = (e) => {
    e.preventDefault();
    if (!selectedBookForLoan || !borrowerName.trim()) {
      alert('Please select a book and enter a borrower name');
      return;
    }
                ...
                <div key={loan.id} className="loan-item">
                  <div className="loan-info">
                    ...
                    <div className="loan-details">
                      ...
                      <span className="loan-date">Loaned on: {formatDate(loan.loanDate)}</span>
                    </div>
                  </div>
                  <button 
