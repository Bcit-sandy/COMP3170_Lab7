                ...
                <div key={loan.id} className="loan-item">
                  <div className="loan-info">
                    ...
                    <div className="loan-details">
                      <span className="loan-borrower">Borrower: <strong>{loan.borrower}</strong></span>
                      <span className="loan-period">Period: <strong>{loan.loanPeriod || 'N/A'} week(s)</strong></span>
                      <span className="loan-date">Return by: <strong>{loan.loanPeriod ? calculateReturnDate(loan.loanDate, loan.loanPeriod) : 'N/A'}</strong></span>
                    </div>
                  </div>
                  {/* <button 
