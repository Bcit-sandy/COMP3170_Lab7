  ...
  return (
    ...
    >
      <div className="book-cover">
        ...
        <p className="book-publisher">{data.publisher}</p>
        <p className="book-year">{data.year}</p>
        <p className="book-language">{data.language}</p>
        <p className="book-pages">{data.pages}</p>
        <p className="book-image">{data.image}</p>
      </div>
