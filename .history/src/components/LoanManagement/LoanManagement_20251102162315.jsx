        ...
        <div className="loan-form-section">
          {availableBooks.length === 0 ? (
            <div className="all-books-loaned-message">
              <h3>All Books Are Currently On Loan</h3>
              <p>There are no available books to loan at this time. Please return some books first to make them available for new loans.</p>
            </div>
          ) : (
            <>
              <h3>Loan a Book</h3>
                ...
                <div key={loan.id} className="loan-item">
                  <div className="loan-info">
                    ...
                    <div className="loan-details">
                      <div> <span className="loan-borrower">Borrower:</span> {loan.borrower} </div>
                      <div> <span className="loan-period">Period:</span> {loan.loanPeriod || 'N/A'} week(s) </div>
                      <div> <span className="loan-date">Return by:</span> {loan.loanPeriod ? calculateReturnDate(loan.loanDate, loan.loanPeriod) : 'N/A'} </div>
                    </div>
                  </div>
                  {/* <button 
